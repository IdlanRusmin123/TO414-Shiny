...
fun1 <- function(fbref) {
standard <- fb_player_season_stats(fbref, stat_type = 'standard', time_pause = runif(1, 0, 3))
shooting <- fb_player_season_stats(fbref, stat_type = 'shooting', time_pause = runif(1, 0, 3))
gca <- fb_player_season_stats(fbref, stat_type = 'gca', time_pause = runif(1, 0, 3))
passing <- fb_player_season_stats(fbref, stat_type = 'passing', time_pause = runif(1, 0, 3))
possession <- fb_player_season_stats(fbref, stat_type = 'possession', time_pause = runif(1, 0, 3))
